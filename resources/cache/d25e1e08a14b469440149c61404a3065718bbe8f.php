...
<table class="table">
    ...
    foreach ($__currentLoopData as $post): $__env->incrementLoopIndices();
        ...
        <tr>
            ...
            <td><a href="/posts/<?php echo e($post->id); ?>/edit">UPDATE</a></td>
            <td><a href="/posts/<?php echo e($post->id); ?>/delete">DELETE</a></td>
            <td><a href="/posts/<?php echo e($post->id); ?>/show">SHOW</a></td>
        </tr>
    <?php endforeach;
    $__env->popLoop();
    $loop = $__env->getLastLoop();
...
<a class="btn btn-primary" href="/posts/create"> ADD MORE </a>
<br>
<a class="btn btn-info" href="/posts/trash"> TRASH </a>
<br>
