...
/*Creating Post Tags*/
//$post1 = Post::find(1);
//$post1->tag()->attach([1.8,9]);
//$post1 = Post::find(2);
//$post1->tag()->attach([2,3,8]);
//$post1 = Post::find(3);
//$post1->tag()->attach([2,4,9]);
//$post1 = Post::find(4);
//$post1->tag()->attach([5,8,9]);
//$post1 = Post::find(5);
//$post1->tag()->attach([6,7,9]);
//$post1 = Post::find(6);
//$post1->tag()->attach([4,7,9]);
//$post1 = Post::find(7);
//$post1->tag()->attach([4,7,8]);
//$post1 = Post::find(8);
//$post1->tag()->attach([7,8,9]);
//$post1 = Post::find(9);
//$post1->tag()->attach([7,5,3]);

/*Creating Post Categories*/
//$post1 = Post::find(1);
//$post1->categories()->attach([1]);
//$post2 = Post::find(2);
//$post2->categories()->attach([2]);
//$post3 = Post::find(3);
//$post3->categories()->attach([2]);
//$post4 = Post::find(4);
//$post4->categories()->attach([3]);
//$post5 = Post::find(5);
//$post5->categories()->attach([3]);
//$post6 = Post::find(6);
//$post6->categories()->attach([3]);
//$post7 = Post::find(7);
//$post7->categories()->attach([5]);
//$post8 = Post::find(8);
//$post8->categories()->attach([5]);
//$post9 = Post::find(9);
//$post9->categories()->attach([4]);
